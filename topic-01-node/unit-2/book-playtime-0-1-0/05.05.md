...
The db.js module serves as s simple "gateway" or "Façade" to the models, which are made available via the `db` object. We will see how this is accessed in the next step.
